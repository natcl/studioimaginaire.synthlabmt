{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 590.0, 50.0, 1081.0, 708.0 ],
		"bglocked" : 0,
		"defrect" : [ 590.0, 50.0, 1081.0, 708.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "dac~ 2",
					"fontname" : "Arial",
					"patching_rect" : [ 422.0, 558.0, 47.0, 20.0 ],
					"id" : "obj-17",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"text" : "dac~ 1",
					"fontname" : "Arial",
					"patching_rect" : [ 337.0, 558.0, 47.0, 20.0 ],
					"id" : "obj-16",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 343.0, 69.0, 102.0, 20.0 ],
					"id" : "obj-34",
					"fontsize" : 12.0,
					"numinlets" : 2,
					"numoutlets" : 1,
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 348.0, 412.0, 1235.0, 646.0 ],
						"bglocked" : 0,
						"defrect" : [ 348.0, 412.0, 1235.0, 646.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 158.0, 100.5, 78.0, 20.0 ],
					"id" : "obj-23",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 92.0, 100.5, 63.0, 20.0 ],
					"id" : "obj-21",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "ezdac~",
					"patching_rect" : [ 654.0, 236.0, 45.0, 45.0 ],
					"id" : "obj-127",
					"numinlets" : 2,
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"fontname" : "Arial",
					"patching_rect" : [ 343.0, 19.0, 60.0, 20.0 ],
					"id" : "obj-43",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 343.0, 43.0, 57.0, 18.0 ],
					"id" : "obj-42",
					"fontsize" : 12.0,
					"numinlets" : 2,
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "", "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 92.0, 36.0, 178.0, 20.0 ],
					"id" : "obj-13",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 4
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 92.0, 7.0, 99.0, 20.0 ],
					"id" : "obj-12",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 406.0, 217.0, 69.0, 20.0 ],
					"id" : "obj-6",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal" ],
					"fontname" : "Arial",
					"patching_rect" : [ 62.0, 267.0, 70.0, 20.0 ],
					"id" : "obj-1",
					"fontsize" : 12.0,
					"numinlets" : 0,
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal" ],
					"fontname" : "Arial",
					"patching_rect" : [ 233.0, 409.0, 57.0, 20.0 ],
					"id" : "obj-3",
					"fontsize" : 12.0,
					"numinlets" : 4,
					"numoutlets" : 1
